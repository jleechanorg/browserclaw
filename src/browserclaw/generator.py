...
def render_curl_replay(har_path: str | Path) -> str:
    """Generate a shell script with verbatim curl commands for every HAR request.

    Skips binary/media resources. Auth tokens are included as-is so the script
    can be used to replay or as a starting point for reverse-engineering.
    """
